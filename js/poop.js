$(function() {
  ...
  // Select poop descriptors
  $("#symp-poop").on("change", function() {
    if ( $(this).is(":checked") ) { $("#poop-consistency, #poop-warn").prop("disabled", false); }
    else {
      $("#poop-consistency, #poop-warn").prop("disabled", true);
    }
  });
